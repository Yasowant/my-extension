...
async function troubleshoot() {
  ...
  return showGuide([
    ...
    semantic === true ? 'Semantic highlighting is explicitly enabled and may override HTTP grammar colours.' : 'Dusk Forge defaults to grammar colours. Theme-specific semantic overrides may still take precedence.',
